 ...
 * {@link SequentialSearchST2}, {@link BST}, {@link RedBlackBST}, and
...
public class SeparateChainingHashST<Key, Value> {
    ...
    public SequentialSearchST2<Key, Value>[] st;  // array of linked-list symbol tables
//    private int lgM;
//    private int primes = new int[]{} ;
    ...
    public SeparateChainingHashST(int m) {
        this.m = m;
        st = (SequentialSearchST2<Key, Value>[]) new SequentialSearchST2[m];
        for (int i = 0; i < m; i++)
            st[i] = new SequentialSearchST2<Key, Value>();
    }
